...
SECTIONS = [
    {
        "id": "calendar",
        "title": "Calendar & Circuits",
        "desc": "How the championship schedule grew in volume, density, and geographic breadth.",
    },
    {
        "id": "geographic",
        "title": "Geographic Evolution",
        "desc": "Race hosting by region and the spherical center of gravity path through time.",
    },
    {
        "id": "nationality",
        "title": "Nationality & Talent",
        "desc": "Structural diversification and regional waves of drivers on the grid.",
    },
    {
        "id": "competition",
        "title": "Competition Dynamics",
        "desc": "Team driver utilization and win dominance across eras.",
    },
    {
        "id": "performance",
        "title": "Performance & Demographics",
        "desc": "Pit-lane pace evolution and shifting driver age profiles.",
    },
]
                ...
                children=[
                    ...
                    html.Ul(
                        ...
                        children=[
                            html.Li(
                                children=insight,
                                className="pl-4 border-l-2 border-f1-blue",
                            )
...
def _section(
    section_id: str, section_badge: str, title: str, blurb: str, children: list
):
    return html.Div(
        id=section_id,
                                    ...
                                    children=[
                                        ...
                                        html.P(
                                            [
                                                ...
                                                "From ",
                                                html.Span(
                                                    className="font-bold text-f1-red"
                                                ),
                                                "Schumacher's Ferrari dynasty",
                                                html.Span(className="font-normal"),
                                                " to ",
                                                html.Span(
                                                    className="font-bold text-f1-blue"
                                                ),
                                                "Hamilton's record-breaking reign",
                                                html.Span(className="font-normal"),
                                                ", explore how the sport transformed from a ",
                                                html.Span(
                                                    className="font-bold text-f1-orange"
                                                ),
                                                "49% European driver field in 1950",
                                                html.Span(className="font-normal"),
                                        ...
                                        html.Div(
                                            ...
                                            children=[
                                                html.Div(
                                                    ...
                                                    children=[
                                                        html.H3(
                                                            className="text-3xl font-bold text-f1-red mb-2"
                                                        ),
                                                        "🏆",
                                                        html.P(
                                                ...
                                                html.Div(
                                                    ...
                                                    children=[
                                                        html.H3(
                                                            className="text-3xl font-bold text-f1-blue mb-2"
                                                        ),
                                                        "🎂",
                                                        html.P(
                                                ...
                                                html.Div(
                                                    ...
                                                    children=[
                                                        html.H3(
                                                            className="text-3xl font-bold text-f1-orange mb-2"
                                                        ),
                                                        "🌍",
                                                        html.P(
                    ...
                    children=[
                        _section(
                            ...
                            [
                                _viz_card(
                                    ...
                                    "The data shows dramatic expansion from an average of 8.4 races per season in the 1950s to 21.4 races in the 2020s - more than doubling the calendar size over seven decades.",
                                    _graph(
                                        build_calendar_volume(),
                                ...
                                _viz_card(
                                    ...
                                    "The matrix shows how legendary circuits like Monaco (70 races), Monza (74 races), and Silverstone (59 races) have appeared most frequently throughout history, though with intermittent gaps.",
                                    _graph(
                                        build_circuit_presence(),
                                        config=STATIC_GRAPH_CONFIG,
                                    ),
                                    [
                                ...
                                _viz_card(
                                    ...
                                    "The dramatic shift from purple to blue tells the story of F1's transformation from 100% classic tracks in the 1950s to just 21-23% by the 2010s-2020s, reflecting a fundamental restructuring of the championship.",
                                    _graph(
                                        build_venue_share(), config=STATIC_GRAPH_CONFIG
                                    ),
                                    [
                        ...
                        _section(
                            ...
                            [
                                _viz_card(
                                    ...
                                    _graph(build_viz8(), config=STATIC_GRAPH_CONFIG),
                                    [
                                ...
                                # Answer to hero curiosity question
                                html.Div(
                                    className="mt-4 bg-gradient-to-r from-f1-blue/10 to-purple-100 rounded-lg p-6 border-l-6 border-indigo-500 shadow-sm",
                                    children=[
                                        html.H5(
                                            ...
                                            children=[
                                                html.Span("🌍"),
                                                html.Span(
                                                    "Answer to Our Mystery Question"
                                                ),
                                            ],
                                        ),
                                        html.P(
                                            ...
                                            children=[
                                                "Why did North America go from 43% to under 2%? Look at the stacked area chart. Notice the huge ",
                                                html.Span(
                                                    className="font-bold text-gray-600",
                                                    children="gray band in the 1950s",
                                                ),
                                                " (North America). This was because early F1 included ",
                                                html.Span(
                                                    className="font-bold text-f1-red",
                                                    children="IndyCar-style oval races like Indianapolis",
                                                ),
                                                " that attracted American drivers. When F1 became purely European road courses in the 1960s, Americans stopped coming because it was too far to travel, had a different racing culture, and offered no incentive to leave IndyCar behind.",
                                            ],
                                        ),
                                    ],
                                ),
                        ...
                        _section(
                            ...
                            [
                                _viz_card(
                                    ...
                                    _graph(build_q24(), config=STATIC_GRAPH_CONFIG),
                                    [
                                ...
                                # Answer to hero curiosity question
                                html.Div(
                                    className="mt-4 bg-gradient-to-r from-f1-blue/10 to-blue-100 rounded-lg p-6 border-l-6 border-f1-blue shadow-sm",
                                    children=[
                                        html.H5(
                                            className="text-xl font-bold text-gray-800 mb-3 flex items-center gap-2",
                                            children=[
                                        ...
                                        html.P(
                                            className="text-gray-700 leading-relaxed",
                                            children=[
                                                "Which driver won the MOST races in a single decade? Look at the 2010s column on the heatmap. You'll see Lewis Hamilton's name with ",
                                                html.Span(
                                                    className="font-bold text-f1-blue",
                                                    children="73 wins",
                                                ),
                                                ". That's more than Schumacher (62 in 2000s) and Verstappen (55 in 2020s). The dark red intensity for Hamilton-2010s shows unprecedented dominance!",
                                            ],
                                        ),
                                    ],
                                ),
                        ...
                        _section(
                            ...
                            [
                                ...
                                # Answer to hero curiosity question
                                html.Div(
                                    className="mt-4 bg-gradient-to-r from-green-50/80 to-green-100 rounded-lg p-6 border-l-6 border-green-500 shadow-sm",
                                    children=[
                                        html.H5(
                                            className="text-xl font-bold text-gray-800 mb-3 flex items-center gap-2",
                                            children=[
                                        ...
                                        html.P(
                                            className="text-gray-700 leading-relaxed",
                                            children=[
                                                "Why haven't pit stops gotten faster since 2012? Look at the line chart. You'll see ",
                                                html.Span(
                                                    className="font-bold text-green-600",
                                                    children="flat performance around 23-24 seconds",
                                                ),
                                                " despite 12 years of technology. Two reasons: ",
                                                html.Span(
                                                    className="font-bold",
                                                    children="(1) Regulations changed in 2014",
                                                ),
                                                " Tire changes became mandatory (slower than optional before), and fuel restrictions altered strategy. ",
                                                html.Span(
                                                    className="font-bold",
                                                    children="(2) Physical limits",
                                                ),
                                                " Each wheel takes ~2 seconds to change safely with 2+ mechanics. There's only so much humans can optimize without robotics.",
                                            ],
                                        ),
                                    ],
                                ),
                                ...
                                # Answer to hero curiosity question
                                html.Div(
                                    className="mt-4 bg-gradient-to-r from-f1-orange/10 to-orange-100 rounded-lg p-6 border-l-6 border-f1-orange shadow-sm",
                                    children=[
                                        html.H5(
                                            className="text-xl font-bold text-gray-800 mb-3 flex items-center gap-2",
                                            children=[
                                        ...
                                        html.P(
                                            className="text-gray-700 leading-relaxed",
                                            children=[
                                                "Why are drivers 8 years younger now? Look at the violin plots the 1950s distribution centers around ",
                                                html.Span(
                                                    className="font-bold text-f1-orange",
                                                    children="34.7 years",
                                                ),
                                                " while the 2020s centers at ",
                                                html.Span(
                                                    className="font-bold text-green-600",
                                                    children="26.7 years",
                                                ),
                                                ". This happened because F1 now fast-tracks teenage prodigies from junior formulas (like Verstappen), teams want longer career ROI on investments, and the superlicense system has created a clear pathway for young talent rather than requiring decades of experience.",
                                            ],
                                        ),
                                    ],
                                ),
